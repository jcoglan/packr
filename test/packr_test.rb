...
class PackrTest < Test::Unit::TestCase
  ...
  def test_private_variable_packing
    script = "var _KEYS = true, _MY_VARS = []; (function() { var foo = _KEYS; _MY_VARS.push({_KEYS: _KEYS}); })();"
    assert_equal "var _0=true,_1=[];(function(){var a=_0;_1.push({_KEYS:_1})})();", Packr.pack(script, :shrink => true, :private => true)
  end
